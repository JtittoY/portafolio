            ...
            <div className="container mx-auto px-6 grid md:grid-cols-2 gap-16 items-center relative z-10">
                <div className="order-2 md:order-1 reveal-on-scroll">
                    ...
                    <div className="flex flex-wrap gap-3 mb-8">
                        ...
                        <a href={SOCIAL_LINKS.cv} target="_blank" rel="noopener noreferrer" className="px-6 py-3 border border-slate-300 dark:border-slate-600 text-slate-600 dark:text-slate-300 rounded-lg font-medium text-sm hover:border-accent-500 hover:text-accent-600 dark:hover:text-accent-400 transition-all duration-300">
                            Descargar CV
                        </a>
                    </div>
                ...
                <div className="order-1 md:order-2 flex justify-center reveal-on-scroll" style={{ transitionDelay: '150ms' }}>
                    <div className="relative w-56 h-56 md:w-72 md:h-72">
                        ...
                        <div className="absolute inset-4 rounded-full border border-accent-200/40 dark:border-accent-700/20 animate-[spin_40s_linear_infinite]" ></div>
                        <div className="absolute inset-6 rounded-full bg-gradient-to-br from-accent-50 to-slate-100 dark:from-slate-800 dark:to-slate-900 flex items-center justify-center overflow-hidden shadow-xl animate-[spin_40s_linear_infinite]">
                            <img
                            ...
                            />
                            <svg className="w-28 h-28 md:w-36 md:h-36 text-accent-600/60 dark:text-accent-400/50 hidden" viewBox="0 0 120 120" fill="none" aria-label="Avatar minimalista">
