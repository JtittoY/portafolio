...
export default function Contact() {
    ...
    const handleFormSubmit = (e) => {
        ...
        cuerpoEmail += `\n-----------------------\n\n${mensaje}`;
        const gmailUrl = `https://mail.google.com/mail/?view=cm&fs=1&to=${SOCIAL_LINKS.email}&su=${encodeURIComponent(asunto)}&body=${encodeURIComponent(cuerpoEmail)}`;
                    ...
                    <div className="space-y-10 reveal-on-scroll">
                        <div>
                            <h3 className="text-2xl md:text-3xl font-semibold mb-4 text-slate-800 dark:text-white">
                                ¿Buscas un desarrollador<br /><span className="text-accent-600 dark:text-accent-400">para construir tu pagina web?</span>
                            </h3>
                            <p className="text-slate-500 dark:text-slate-400 leading-relaxed max-w-md">
                                ¡Estoy listo para ayudarte! Me especializo en crear sitios web modernos, rápidos y responsivos que se adaptan a cualquier dispositivo.
                            </p>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <a href={SOCIAL_LINKS.github} target="_blank" rel="noopener noreferrer" className="group p-5 bg-surface-light dark:bg-slate-800/50 rounded-2xl border border-slate-200/60 dark:border-slate-700/50 flex items-center gap-5 hover:border-emerald-400/40 transition-all">
                                <div className="w-11 h-11 bg-emerald-50 dark:bg-emerald-900/20 rounded-xl flex items-center justify-center text-emerald-600 group-hover:bg-emerald-600 group-hover:text-white transition-all">
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <div>
                                    <span className="block text-xs text-slate-400 font-medium mb-0.5">GitHub</span>
                                    <span className="text-sm font-semibold text-slate-700 dark:text-white group-hover:text-emerald-600 transition-colors">{SOCIAL_LINKS.github}</span>
                                </div>
                            </a>
                        </div>
                    </div>
